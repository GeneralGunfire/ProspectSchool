...
const TOPIC = {
  ...
  enrichment: {
    outcomes: [
      ...
      'Label the parts of a wave: amplitude, wavelength, crest, trough, compression, rarefaction',
      'Apply the wave equation: v = f × λ to solve for speed, frequency, or wavelength',
      'Explain how sound travels and what affects its speed',
      'Describe the electromagnetic spectrum and where visible light fits',
    ],
    knowledgeChecks: [
      {
        afterStep: 0,
        ...
        options: [
          ...
          'Perpendicular (at right angles) to the direction the wave travels',
          'In a circular motion around the wave path',
          'They do not move — only energy moves',
        ],
        correctIndex: 1,
        explanation: 'In a transverse wave, particles move at right angles (perpendicular) to the direction of wave propagation. Examples include light waves and ripples on water. In longitudinal waves (like sound), particles move parallel to the wave direction.',
      },
      {
        afterStep: 2,
        question: 'A wave has a frequency of 200 Hz and a wavelength of 1.5 m. What is its speed?',
        options: ['133 m/s', '200 m/s', '300 m/s', '1.5 m/s'],
        correctIndex: 2,
        explanation: 'v = f × λ = 200 × 1.5 = 300 m/s. The wave equation v = fλ connects speed (v), frequency (f in Hz), and wavelength (λ in metres). Always write the formula first, substitute, then solve.',
      },
    ],
    examTip: 'The wave equation v = fλ appears in almost every waves question. Rearrange it confidently: f = v/λ and λ = v/f. You will be given two values and asked to find the third — always write the formula first, substitute the known values, then calculate.',
    summaryPoints: [
      'A wave transfers energy from one place to another without transferring matter',
      'Transverse waves: particle vibration is perpendicular to wave direction (e.g. light, water waves)',
      'Longitudinal waves: particle vibration is parallel to wave direction (e.g. sound)',
      'Wave equation: v = f × λ (speed = frequency × wavelength)',
      'Frequency is measured in Hz; wavelength in metres; speed in m/s',
      'Sound requires a medium to travel — it cannot travel through a vacuum; light can',
    ],
  },
}
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={() => setScratchpadKey(`scratchpad_waves_q-${idx}`)}
      ...
      <main className="max-w-3xl mx-auto px-4 pt-24 pb-16">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-[13px] text-stone-400 mt-0.5">Physical Sciences · Grade 10 · Term 1 · Topic 1</p>
          </div>
