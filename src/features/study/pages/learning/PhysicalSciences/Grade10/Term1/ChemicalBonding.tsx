...
const TOPIC = {
  ...
  enrichment: {
    outcomes: [
      'Explain why atoms form chemical bonds using the octet rule',
      'Describe ionic bonding: electron transfer between a metal and a non-metal',
      'Describe covalent bonding: electron sharing between two non-metals',
    ...
    knowledgeChecks: [
      {
        afterStep: 0,
        question: 'Atoms form chemical bonds in order to:',
        options: [
          'Increase their atomic number to become heavier',
          'Achieve a full, stable outer electron shell (usually 8 electrons)',
          'Release energy in the form of heat and light',
          'Become radioactive and unstable',
        ],
        correctIndex: 1,
        explanation: 'Atoms bond to achieve a stable electron configuration — usually a full outer shell of 8 electrons (the octet rule). Noble gases already have full outer shells, which is why they are unreactive and do not form bonds easily.',
      },
      {
        afterStep: 2,
        question: 'Which bond forms when electrons are SHARED between two non-metal atoms?',
        options: [
          'Ionic bond',
          'Metallic bond',
          'Covalent bond',
        ...
        correctIndex: 2,
        explanation: 'A covalent bond forms when two non-metal atoms share one or more pairs of electrons. Each atom contributes electrons to the shared pair. Examples: H₂O, CO₂, CH₄. Neither atom wants to give up electrons completely, so they share instead.',
      },
    ],
    examTip: 'To identify bond type instantly: metal + non-metal → ionic bond (transfer); non-metal + non-metal → covalent bond (sharing); metal + metal → metallic bond (sea of electrons). In dot-and-cross diagrams for covalent bonds, show only the outer shell electrons — not all electrons.',
    summaryPoints: [
      'Atoms bond to achieve a full, stable outer electron shell (octet rule)',
      'Ionic bond: electron transfer from metal (loses, becomes cation) to non-metal (gains, becomes anion)',
      'Covalent bond: electron sharing between two non-metals to achieve full outer shells',
      'Metallic bond: positive metal ions surrounded by a sea of delocalised (free) electrons',
      'Single bond = 1 shared pair; double bond = 2 shared pairs; triple bond = 3 shared pairs',
      'Ionic compounds form crystal lattices; covalent compounds are often molecular; metals conduct electricity due to free electrons',
    ],
  },
}
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={() => setScratchpadKey(`scratchpad_bonding_q-${idx}`)}
      ...
      <main className="max-w-3xl mx-auto px-4 pt-24 pb-16">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-[13px] text-stone-400 mt-0.5">Physical Sciences · Grade 10 · Term 1 · Topic 5</p>
          </div>
