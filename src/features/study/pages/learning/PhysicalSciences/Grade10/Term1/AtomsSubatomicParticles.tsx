...
const TOPIC = {
  ...
  enrichment: {
    outcomes: [
      'Describe the structure of an atom including the nucleus and electron shells',
      'Identify the three subatomic particles and state their charge and relative mass',
      'Determine the number of protons, neutrons, and electrons from an atomic symbol',
      'Explain what atomic number and mass number represent',
    ...
    knowledgeChecks: [
      {
        ...
        options: ['Neutron', 'Electron', 'Proton', 'The nucleus as a whole'],
        correctIndex: 2,
        explanation: 'The number of protons (atomic number) determines which element an atom is. All atoms of the same element have the same number of protons. Changing the number of protons creates a different element entirely.',
      },
      {
        afterStep: 2,
        ...
        options: ['11', '12', '23', '34'],
        correctIndex: 1,
        explanation: 'Neutrons = Mass number − Atomic number = 23 − 11 = 12. This atom is sodium (Na) — it has 11 protons, 11 electrons (neutral atom), and 12 neutrons.',
      },
    ],
    examTip: 'The three key relationships tested in every atoms question: atomic number = protons = electrons (in a neutral atom); mass number = protons + neutrons; neutrons = mass number − atomic number. These calculations appear in every Grade 10 Physical Sciences exam.',
    summaryPoints: [
      'Atoms consist of a nucleus (protons + neutrons) with electrons in shells around it',
      'Proton: positive charge (+1), relative mass 1 — found in the nucleus',
      'Neutron: no charge, relative mass 1 — found in the nucleus',
      'Electron: negative charge (−1), negligible mass — found in shells around the nucleus',
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={() => setScratchpadKey(`scratchpad_atoms_q-${idx}`)}
      ...
      <main className="max-w-3xl mx-auto px-4 pt-24 pb-16">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-[13px] text-stone-400 mt-0.5">Physical Sciences · Grade 10 · Term 1 · Topic 2</p>
          </div>
