...
const TOPIC = {
  ...
  enrichment: {
    outcomes: [
      ...
      'Explain what a file path is and read an absolute file path correctly',
      'Apply file naming conventions: no special characters, descriptive names, use of dates',
      'Explain the purpose of file extensions and identify common ones',
      'Describe good file management practices including backup and folder structure',
    ],
    knowledgeChecks: [
      {
        afterStep: 0,
        ...
        correctIndex: 1,
        explanation: '.xlsx is the file extension for Microsoft Excel workbooks. Common extensions to know: .docx (Word), .xlsx (Excel), .pptx (PowerPoint), .pdf (PDF), .jpg/.png (images), .mp3 (audio), .zip (compressed archive).',
      },
      {
        afterStep: 2,
        question: 'Which file name follows best practice conventions?',
        options: [
          'my file (final) v3 NEW!!.docx',
          '2024-03-15_History_Assignment.docx',
          'C:/Users/file?.docx',
          'untitled.docx',
        ],
        correctIndex: 1,
        explanation: 'Good file names are descriptive, include a date for version control, avoid special characters (?, !, spaces in paths), and indicate the content. "2024-03-15_History_Assignment.docx" is clear, dated, and uses underscores instead of spaces.',
      },
    ],
    examTip: 'Know your file extensions by category: Documents (.docx, .pdf, .txt), Spreadsheets (.xlsx, .csv), Presentations (.pptx), Images (.jpg, .png, .gif, .bmp), Audio (.mp3, .wav), Video (.mp4, .avi), Compressed (.zip, .rar). A file path shows exactly where a file is stored — e.g. C:\\Users\\Student\\Documents\\Assignment.docx.',
    summaryPoints: [
      'A file stores data; a folder (directory) organises files into a hierarchy',
      'File extensions indicate the file type and which program opens it',
      'A file path shows the exact location: drive → folders → filename (e.g. C:\\Documents\\Task.docx)',
      'Good naming: descriptive, no special characters, use dates or version numbers',
      'Backup rule: keep copies in at least two locations (e.g. local + cloud/USB)',
      'Root directory is the top-level folder of a drive (e.g. C:\\ on Windows)',
    ],
  },
}
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={() => setScratchpadKey(`scratchpad_cat-files_q-${idx}`)}
      ...
      <main className="max-w-3xl mx-auto px-4 pt-24 pb-16">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-[13px] text-stone-400 mt-0.5">CAT · Grade 10 · Term 1 · Topic 2</p>
          </div>
