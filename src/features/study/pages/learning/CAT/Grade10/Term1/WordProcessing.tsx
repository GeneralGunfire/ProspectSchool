...
const TOPIC = {
  ...
  initialQuestions: [
    { id: 'wp-i1', question: 'Which keyboard shortcut is used to SAVE a document in Microsoft Word?',
      options: ['Ctrl+P', 'Ctrl+S', 'Ctrl+Z', 'Ctrl+A'],
      correctIndex: 1,
      hint: 'Ctrl+S saves the current document.',
      explanation: 'Ctrl+S saves the current document. Ctrl+P prints, Ctrl+Z undoes the last action, Ctrl+A selects all text.',
    },
    { id: 'wp-i2', question: 'A learner wants text to have even edges on both the left and right sides of the page. Which alignment should she choose?',
      options: ['Left', 'Centre', 'Right', 'Justify'],
      correctIndex: 3,
      hint: 'Justify alignment spaces words so both the left and right edges are even.',
    ...
    { id: 'wp-i3', question: 'In Microsoft Word, where would you find the Bold, Italic, and Underline buttons?',
      options: ['Insert tab', 'Layout tab', 'Home tab', 'View tab'],
      correctIndex: 2,
      hint: 'Bold, Italic, and Underline are in the Home tab under the Font group.',
    ...
    { id: 'wp-i4', question: 'What does "line spacing of 2.0" mean in a Word document?',
      options: [
      ...
      correctIndex: 1,
      hint: 'Line spacing of 2.0 (double spacing) means there is twice the normal amount of.',
  ...
  remediationQuestions: [
    { id: 'wp-r1', question: 'Which keyboard shortcut UNDOES the last action in Word?',
      options: ['Ctrl+Y', 'Ctrl+U', 'Ctrl+Z', 'Ctrl+X'],
      correctIndex: 2,
      hint: 'Ctrl+Z undoes the last action.',
    ...
    { id: 'wp-r2', question: 'A learner changes her essay\'s font to "Comic Sans MS, 8pt". Her teacher asks her to fix it. What should the correct body text formatting be?',
      options: [
      ...
      correctIndex: 1,
      hint: 'Standard body text is a readable font (Calibri, Arial, or Times New Roman) at 11–12pt.',
  ...
  hardQuestions: [
    { id: 'wp-h1', question: 'A learner uses "Format Painter" in Word. What does this tool do?',
      options: [
      ...
      correctIndex: 1,
      hint: 'Format Painter (paintbrush icon in Home tab) copies all formatting (font, size,.',
    ...
    { id: 'wp-h2', question: 'A teacher requires a report with: A4 page, 2.54cm margins, Calibri 12pt, 1.5 line spacing, page numbers at the bottom. Where would a learner insert page numbers?',
      options: [
      ...
      correctIndex: 1,
      hint: 'Page numbers are inserted via Insert tab → Header & Footer group → Page Number.',
    ...
    { id: 'wp-h3', question: 'A learner accidentally selects all text and presses Delete. What is the quickest way to recover the text?',
      options: [
      ...
      correctIndex: 1,
      hint: 'Ctrl+Z immediately undoes the last action.',
    ...
    { id: 'wp-h4', question: 'Which of the following BEST describes the difference between a Word template (.dotx) and a regular Word document (.docx)?',
      options: [
      ...
      correctIndex: 1,
      hint: 'A Word template (.dotx) is a reusable starting point.',
  ...
  enrichment: {
    outcomes: [
      'Navigate the Microsoft Word interface: Ribbon, tabs, groups, and rulers',
      'Apply character formatting: font, size, bold, italic, underline, colour',
      'Apply paragraph formatting: alignment, line spacing, indents, and bullets',
      'Use Find & Replace, spell check, and word count tools',
      'Insert and format tables, images, and page numbers in a document',
    ],
    knowledgeChecks: [
      {
        afterStep: 0,
        question: 'Which keyboard shortcut applies BOLD formatting in Microsoft Word?',
        options: ['Ctrl + I', 'Ctrl + U', 'Ctrl + B', 'Ctrl + F'],
        correctIndex: 2,
        explanation: 'Ctrl + B applies Bold formatting. The core formatting shortcuts: Ctrl + B = Bold, Ctrl + I = Italic, Ctrl + U = Underline. These work in Word, Excel, and most text editors. Ctrl + F opens the Find dialog.',
      },
      {
        afterStep: 2,
        question: 'What does "line spacing" control in a Word document?',
        options: [
          'The space between individual characters (kerning)',
          'The vertical space between lines of text within a paragraph',
          'The margin size at the top and bottom of the page',
          'The number of columns in the document layout',
        ],
        correctIndex: 1,
        explanation: 'Line spacing controls the vertical distance between lines of text. Common settings: Single (1.0), 1.5 lines, and Double (2.0). Academic documents often require 1.5 or double spacing. Access it via Home → Paragraph → Line Spacing.',
      },
    ],
    examTip: 'Know the difference between character formatting (affects selected text: font, size, bold, italic, colour) and paragraph formatting (affects whole paragraph: alignment, line spacing, indents, bullets). In CAT practicals, always select text BEFORE applying formatting — or use Format Painter to copy formatting.',
    summaryPoints: [
      'Microsoft Word is word processing software for creating, editing, and formatting documents',
      'Character formatting: font type, size, bold (Ctrl+B), italic (Ctrl+I), underline (Ctrl+U), colour',
      'Paragraph formatting: alignment (left/centre/right/justify), line spacing, indents, bullets',
      'Page layout: margins, orientation (portrait/landscape), page size, columns',
      'Useful tools: Spell check (F7), Find & Replace (Ctrl+H), Word Count (Review tab)',
      'Save as .docx for editing; save as .pdf to share in a non-editable format',
    ],
  },
}
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={() => setScratchpadKey(`scratchpad_cat-word_q-${idx}`)}
      ...
      <main className="max-w-3xl mx-auto px-4 pt-24 pb-16">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-[13px] text-stone-400 mt-0.5">CAT · Grade 10 · Term 1 · Topic 3</p>
          </div>
