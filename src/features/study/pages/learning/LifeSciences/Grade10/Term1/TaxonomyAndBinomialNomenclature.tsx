...
const TOPIC = {
  ...
  enrichment: {
    outcomes: [
      'Define taxonomy and explain its importance in the study of biology',
      'State the rules of binomial nomenclature precisely',
      'Write a scientific name correctly using proper formatting',
      'Explain the contributions of Carolus Linnaeus to taxonomy',
      'Distinguish between common names and scientific names and justify why scientific names are preferred',
    ],
    knowledgeChecks: [
      {
        afterStep: 0,
        question: 'Which scientist developed the modern system of binomial nomenclature?',
        options: ['Charles Darwin', 'Gregor Mendel', 'Carolus Linnaeus', 'Louis Pasteur'],
        correctIndex: 2,
        explanation: 'Carolus Linnaeus (1707–1778) developed the binomial naming system used today. He classified thousands of plants and animals and introduced the two-part Latin naming system (Genus + species) that all scientists worldwide now use.',
      },
      {
        afterStep: 2,
        question: 'Which scientific name is written correctly?',
        options: ['homo sapiens', 'Homo Sapiens', 'Homo sapiens', 'homo Sapiens'],
        correctIndex: 2,
        explanation: 'The correct format: Genus name is capitalised, species name is lowercase. Both words are italicised when typed or underlined when handwritten. So the correct form is Homo sapiens for the human species.',
      },
    ],
    examTip: 'The three binomial nomenclature rules most commonly tested: (1) Genus is capitalised, species is lowercase. (2) Both words are italicised in print or underlined in handwriting. (3) Names are based on Latin or Greek. These rules are straightforward — learn them exactly as they appear in textbooks.',
    summaryPoints: [
      'Taxonomy is the science of naming, describing, and classifying organisms into groups',
      'Binomial nomenclature: every organism has exactly two names — Genus (capital) + species (lowercase)',
      'Scientific names are italicised when typed; underlined when handwritten',
      'Developed by Carolus Linnaeus in the 18th century using Latin and Greek',
      'Scientific names are universal — the same in every language and country worldwide',
      'Common names vary by region and language; scientific names are standardised and unambiguous',
    ],
  },
}
...
const GRADE = 10
const TOPIC_ID = 'taxonomy-and-binomial-nomenclature'
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={() => setScratchpadKey(`scratchpad_taxonomy_q-${idx}`)}
      ...
      <main className="max-w-3xl mx-auto px-4 pt-24 pb-16">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-[13px] text-stone-400 mt-0.5">Life Sciences · Grade 10 · Term 1 · Topic 3</p>
          </div>
