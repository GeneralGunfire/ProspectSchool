...
const TOPIC = {
  ...
  enrichment: {
    outcomes: [
      'Name and describe the five kingdoms of life',
      'State the key characteristics used to distinguish each kingdom from the others',
      'Classify an organism into the correct kingdom given a set of characteristics',
      'Distinguish between prokaryotic and eukaryotic cells',
      'Give at least two examples of organisms from each kingdom',
    ],
    knowledgeChecks: [
      {
        afterStep: 0,
        question: 'Which kingdom contains organisms that are prokaryotic (no nucleus)?',
        options: ['Fungi', 'Protista', 'Monera', 'Plantae'],
        correctIndex: 2,
        explanation: 'Kingdom Monera (Prokaryota) contains bacteria and cyanobacteria — the only organisms with prokaryotic cells. Prokaryotic cells lack a membrane-bound nucleus. All other kingdoms have eukaryotic cells with a true membrane-bound nucleus.',
      },
      {
        afterStep: 2,
        question: 'Which statement correctly describes the Fungi kingdom?',
        options: [
          'Fungi are autotrophs that produce food by photosynthesis',
          'Fungi are heterotrophs that absorb nutrients from dead or living organisms',
          'Fungi are always prokaryotic unicellular organisms',
          'Fungi have cell walls made of cellulose like plants',
        ],
        correctIndex: 1,
        explanation: 'Fungi are heterotrophs — they cannot make their own food. They secrete digestive enzymes onto their food source and absorb the dissolved nutrients (saprotrophic nutrition). Fungi are eukaryotic with cell walls made of chitin, not cellulose.',
      },
    ],
    examTip: 'When asked to identify a kingdom from a description, focus on four key features: (1) cell type — prokaryote or eukaryote; (2) nutrition — autotroph or heterotroph; (3) body organisation — unicellular or multicellular; (4) cell wall composition — chitin (Fungi), cellulose (Plantae), or none (Animalia).',
    summaryPoints: [
      'Kingdom Monera: prokaryotic, unicellular, includes bacteria and cyanobacteria',
      'Kingdom Protista: eukaryotic, mostly unicellular, includes Amoeba, Euglena, and Plasmodium',
      'Kingdom Fungi: eukaryotic, heterotrophic by absorption, cell walls of chitin',
      'Kingdom Plantae: eukaryotic, multicellular, autotrophic (photosynthesis), cell walls of cellulose',
      'Kingdom Animalia: eukaryotic, multicellular, heterotrophic, no cell wall',
      'Prokaryotic cells have no membrane-bound nucleus; eukaryotic cells do',
    ],
  },
}
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={() => setScratchpadKey(`scratchpad_kingdoms_q-${idx}`)}
      ...
      <main className="max-w-3xl mx-auto px-4 pt-24 pb-16">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-[13px] text-stone-400 mt-0.5">Life Sciences · Grade 10 · Term 1 · Topic 2</p>
          </div>
