...
const TOPIC = {
  ...
  enrichment: {
    outcomes: [
      'State and explain the biological species concept',
      'Explain what reproductive isolation means and its role in speciation',
      'Distinguish between allopatric and sympatric speciation with examples',
      'Explain why the species concept is sometimes difficult to apply in practice',
      'Apply the biological species concept to real examples to determine if two populations are the same species',
    ],
    knowledgeChecks: [
      {
        afterStep: 0,
        question: 'According to the biological species concept, a species is defined as:',
        options: [
          'All organisms that look identical or very similar to each other',
          'A group of organisms that can interbreed naturally and produce fertile offspring',
          'All organisms living in the same geographic habitat',
          'Organisms that share more than 90% of their DNA sequence',
        ],
        correctIndex: 1,
        explanation: 'The biological species concept (Ernst Mayr, 1942) defines a species as a group of organisms that can interbreed naturally and produce fertile offspring. Reproductive isolation from other groups is the defining criterion.',
      },
      {
        afterStep: 2,
        question: 'Two populations of the same species are separated by a new mountain range for thousands of years and eventually become unable to interbreed. This is an example of:',
        options: [
        ...
        correctIndex: 2,
        explanation: 'Allopatric speciation occurs when populations are geographically isolated (allopatric = different homeland). The mountain range acts as a physical barrier. Over time, the isolated populations evolve independently until they can no longer interbreed — they have become separate species.',
      },
    ],
    examTip: 'The most commonly tested definition: biological species = organisms that can interbreed AND produce FERTILE offspring. A classic exam example: a horse and donkey can breed to produce a mule, but mules are sterile — so horses and donkeys are different species. Always include the word "fertile" in your definition.',
    summaryPoints: [
      'Biological species concept: organisms that can interbreed naturally and produce fertile offspring',
      'Reproductive isolation prevents gene flow between populations and drives speciation',
      'Allopatric speciation: geographic separation causes divergence (e.g. mountain range, river, ocean)',
      'Sympatric speciation: new species form within the same geographic area (e.g. different mating seasons)',
      'Limitations: the concept cannot apply to asexual organisms, fossils, or ring species',
...
const GRADE = 10
const TOPIC_ID = 'species-concept'
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={() => setScratchpadKey(`scratchpad_species_q-${idx}`)}
      ...
      <main className="max-w-3xl mx-auto px-4 pt-24 pb-16">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-[13px] text-stone-400 mt-0.5">Life Sciences · Grade 10 · Term 1 · Topic 4</p>
          </div>
