...
const TOPIC = {
  ...
  enrichment: {
    outcomes: [
      'Name and describe the four factors of production',
      'State the reward (income) each factor earns',
      'Give examples of each factor of production in a South African context',
      'Explain why entrepreneurship is considered a separate factor from capital',
      'Describe how improving any factor of production increases productive capacity',
    ],
    knowledgeChecks: [
      {
        afterStep: 0,
        question: 'Which factor of production earns RENT as its reward?',
        options: ['Labour', 'Capital', 'Entrepreneurship', 'Land'],
        correctIndex: 3,
        explanation: 'Land earns rent as its reward. Land includes all natural resources — soil, minerals, water, forests, and fishing areas. In South Africa, land is especially significant given the importance of mining and agriculture. The rent paid for land reflects its scarcity and productivity.',
      },
      {
        afterStep: 2,
        question: 'An entrepreneur risks their own money to start a new business. What reward do they earn if successful?',
        options: ['Wages', 'Interest', 'Rent', 'Profit'],
        correctIndex: 3,
        explanation: 'Entrepreneurs earn profit as their reward for organising the other three factors of production and bearing risk. If the business fails, they bear the loss. If it succeeds, profit is their compensation for taking that risk and for their organisational skill.',
      },
    ],
    examTip: 'Learn all four factors with their rewards as a set: Land → Rent, Labour → Wages/Salaries, Capital → Interest, Entrepreneurship → Profit. Exams frequently ask you to match the factor to its reward or to classify a resource (e.g. "a tractor" = Capital; "a coal mine" = Land; "a factory manager" = Labour).',
    summaryPoints: [
      'Land: all natural resources (soil, minerals, water, forests) — reward: Rent',
      'Labour: all human physical and mental effort — reward: Wages and Salaries',
      'Capital: manufactured aids to production (machinery, tools, buildings) — reward: Interest',
      'Entrepreneurship: organising the other factors and bearing risk — reward: Profit',
      'Capital in economics means physical capital (machines, factories) — NOT money',
      'Improving the quality or quantity of any factor increases the economy\'s productive capacity',
    ],
  },
}
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={() => setScratchpadKey(`scratchpad_econ-factors_q-${idx}`)}
      ...
      <main className="max-w-3xl mx-auto px-4 pt-24 pb-16">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-[13px] text-stone-400 mt-0.5">Economics · Grade 10 · Term 1 · Topic 5</p>
          </div>
