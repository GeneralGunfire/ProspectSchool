...
const TOPIC = {
  ...
  enrichment: {
    outcomes: [
      'Explain the purpose of the general ledger in the accounting cycle',
      'Draw and label a T-account correctly with debit and credit sides',
      'Post journal entries to the correct ledger accounts',
      'Balance a ledger account at the end of a period using c/d and b/d',
    ...
    knowledgeChecks: [
      {
        ...
        options: [
          'The first book where transactions are originally recorded',
          'A book containing all accounts showing their balances after journal entries are posted',
          'A list of all source documents filed by date',
          'A financial statement showing the profit or loss for the year',
        ],
        correctIndex: 1,
        explanation: 'The general ledger contains every account in the business. Journal entries are transferred (posted) to the ledger accounts, which show all debits, all credits, and the resulting balance for each account.',
      },
      {
        afterStep: 2,
        question: 'The Cash account shows total debits of R15 000 and total credits of R9 000. What is the balance and on which side?',
        options: [
          'R6 000 credit balance',
          'R24 000 debit balance',
          'R6 000 debit balance',
          'R9 000 credit balance',
        ],
        correctIndex: 2,
        explanation: 'Balance = R15 000 − R9 000 = R6 000. Since debits exceed credits for an asset account, the balance is on the debit side. Asset accounts normally carry debit balances.',
      },
    ],
    examTip: 'When balancing a T-account: add up both sides, find the larger total, write that total on both sides, then insert "balance c/d" on the smaller side to make them equal. The opening balance for the next period "balance b/d" appears on the opposite side to close.',
    summaryPoints: [
      'The general ledger is the main accounting record — it contains every account of the business',
      'Posting means transferring journal entries to the relevant ledger accounts',
      'Each T-account has a debit (left) side and a credit (right) side',
      'Assets and expenses normally carry debit balances',
      'Liabilities, equity, and income normally carry credit balances',
      'Balancing: write c/d (carried down) on the smaller side, then b/d (brought down) to open the next period',
    ],
  },
}
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={() => setScratchpadKey(`scratchpad_general-ledger_q-${idx}`)}
      ...
      <main className="max-w-3xl mx-auto px-4 pt-24 pb-16">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-[13px] text-stone-400 mt-0.5">Accounting · Grade 10 · Term 1 · Topic 6</p>
          </div>
