      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="mx-4 mb-4">
            <div className="bg-[#F5F0E8] rounded-xl px-5 py-5 border border-stone-200/50 space-y-2">
      ...
      <AnimatePresence mode="wait">
        <motion.div key={q.id} initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} transition={{ duration: 0.2, ease: [0.23, 1, 0.32, 1] }} className="bg-white rounded-2xl border border-stone-200 shadow-sm overflow-hidden">
          ...
          <div className="px-6 py-4 border-t border-stone-100 flex justify-between items-center">
            ...
            {!confirmed
              ? <button onClick={confirm} disabled={selected === null} className="px-5 py-2.5 bg-[#1C1917] text-white rounded-xl disabled:opacity-25 hover:bg-stone-800 font-black text-sm shadow-sm transition-all">Check Answer</button>
