...
const TOPIC = {
  ...
  enrichment: {
    outcomes: [
      ...
      "Identify the main stakeholders of a business and describe each group's interests",
      'Explain what stakeholder conflict is and give a specific example',
      'Describe strategies a business can use to manage and resolve stakeholder conflicts',
      'Explain why effective stakeholder management is important for long-term business success',
    ],
    knowledgeChecks: [
      {
        afterStep: 0,
        ...
        options: [
          'A customer who regularly buys products from the business',
          'A bank that has lent money to the business',
          'An employee who works for the business',
          'The local community living near the factory',
        ],
        correctIndex: 2,
        explanation: 'Internal stakeholders are part of the business itself — employees, owners/shareholders, and managers. External stakeholders (customers, banks, suppliers, government, community) exist outside the business but are affected by or can affect its decisions.',
      },
      {
        afterStep: 2,
        question: 'Shareholders want maximum profit distributed as dividends, but employees want higher wages. This is an example of:',
        options: [
          'Normal business growth and expansion',
          'Stakeholder conflict between two groups with opposing interests',
          'Corporate social responsibility in action',
          'Market competition reducing profits',
        ],
        correctIndex: 1,
        explanation: 'Stakeholder conflict arises when different stakeholders have competing interests. Higher wages reduce profit available for dividends, so shareholders and employees have opposing goals. Businesses must find ways to balance these competing demands.',
      },
    ],
    examTip: 'When asked to explain a conflict between two stakeholders, use this structure: name both stakeholders → state what each wants → explain why their interests clash → suggest one way to resolve the conflict. All four steps are needed for full marks in Grade 10 exams.',
    summaryPoints: [
      'Stakeholders are all individuals or groups with an interest in the business and its activities',
      'Internal stakeholders: owners, managers, employees — work within the business',
      'External stakeholders: customers, suppliers, banks, government, community — outside the business',
      'Each stakeholder group has different interests, expectations, and levels of influence',
      'Stakeholder conflict occurs when different groups have opposing needs or goals',
      'Businesses manage conflict through communication, negotiation, and balancing competing interests',
    ],
  },
}
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={() => setScratchpadKey(`scratchpad_biz-stakeholders_q-${idx}`)}
      ...
      <main className="max-w-3xl mx-auto px-4 pt-24 pb-16">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-[13px] text-stone-400 mt-0.5">Business Studies · Grade 10 · Term 1 · Topic 3</p>
          </div>
