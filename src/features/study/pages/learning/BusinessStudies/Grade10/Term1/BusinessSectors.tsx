...
const TOPIC = {
  ...
  enrichment: {
    outcomes: [
      ...
      'Give at least two examples of industries in each sector',
      'Explain the role each sector plays in meeting consumer needs',
      'Describe the interdependence and flow between the three sectors',
      'Identify which sector dominates modern economies and explain why',
    ],
    knowledgeChecks: [
      {
        afterStep: 0,
        question: 'Which sector involves the extraction of natural resources directly from the environment?',
        options: [
          'Tertiary sector',
          'Secondary sector',
          'Primary sector',
        ...
        correctIndex: 2,
        explanation: "The primary sector extracts raw materials from nature. Examples include mining, farming, fishing, forestry, and quarrying. South Africa's primary sector is highly significant due to its world-class mining industry (gold, platinum, coal, diamonds).",
      },
      {
        afterStep: 2,
        question: 'A bakery that buys wheat flour and bakes it into bread belongs to the:',
        options: [
          'Primary sector',
          'Secondary sector',
          'Tertiary sector',
          'Primary and tertiary sectors combined',
        ],
        correctIndex: 1,
        explanation: 'The secondary sector converts raw materials into manufactured goods. A bakery takes wheat flour (a primary product) and manufactures bread (a finished good). Other secondary sector examples: car factories, clothing manufacturers, construction companies.',
      },
    ],
    examTip: 'When classifying a business into a sector, ask one question: what does this business do? Extract from nature → primary. Manufacture or process → secondary. Provide a service → tertiary. Services dominate most modern economies because they include banking, retail, transport, education, and healthcare.',
    summaryPoints: [
      'Primary sector: extracts natural resources (mining, agriculture, fishing, forestry)',
      'Secondary sector: manufactures or processes raw materials into goods (factories, construction)',
      'Tertiary sector: provides services (retail, banking, transport, education, healthcare)',
      'The three sectors are interdependent — each relies on inputs and outputs from the others',
      'In developed economies the tertiary sector employs the most workers',
      'South Africa has a significant primary sector (mining and agriculture) and a growing tertiary sector',
    ],
  },
}
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={() => setScratchpadKey(`scratchpad_biz-sectors_q-${idx}`)}
      ...
      <main className="max-w-3xl mx-auto px-4 pt-24 pb-16">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-[13px] text-stone-400 mt-0.5">Business Studies · Grade 10 · Term 1 · Topic 2</p>
          </div>
