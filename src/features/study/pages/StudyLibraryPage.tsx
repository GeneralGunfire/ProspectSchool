      ...
      {step === 'subject' && (
        <>
          {/* ═══ Hero — wave-strip system, matches Home dashboard ═══
              No buttons in this band (house rule). */}
          <div className="relative overflow-hidden">
            ...
            <div className="relative max-w-6xl mx-auto px-5 sm:px-8 pt-8 sm:pt-11 pb-6 sm:pb-8 w-full">
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, ease }}
                ...
                <p className="text-[12px] text-[rgba(31,36,33,0.5)] font-medium truncate">Study Library</p>
              </motion.div>
              ...
              <motion.p initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, ease, delay: 0.08 }}
                className="text-[13px] text-[rgba(31,36,33,0.55)] mt-2.5 font-medium max-w-md">
                Lessons, worked examples and quizzes for every topic — pick a subject to get started.
              </motion.p>
            </div>
          </div>

          <div className="max-w-6xl mx-auto px-4 sm:px-8 relative z-10 space-y-5 sm:space-y-6 pt-2 sm:pt-3 pb-10">
