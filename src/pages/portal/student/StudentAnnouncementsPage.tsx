      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-5 sm:px-8 pt-8 sm:pt-11 pb-10 sm:pb-14 w-full">
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, ease }}
            ...
            <p className="text-[12px] text-[rgba(31,36,33,0.5)] font-medium truncate">Announcements</p>
          </motion.div>
          ...
          {unreadCount > 0 && (
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, ease, delay: 0.1 }}
              ...
              <span className="text-[9px] font-bold uppercase tracking-[0.16em] text-[rgba(31,36,33,0.5)]">UNREAD</span>
              <span className="font-black text-sm text-brand-dark">{unreadCount}</span>
            </motion.div>
          )}
        </div>
      </div>
