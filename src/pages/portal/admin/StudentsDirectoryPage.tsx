    ...
    <div className="px-4 py-6 sm:p-6 md:p-8 max-w-5xl w-full mx-auto">
      <div className="flex items-center justify-between mb-6 gap-3 flex-wrap">
        <div>
          ...
          <h1 className="text-2xl font-black text-brand-dark tracking-tight">Students</h1>
          <p className="text-sm text-stone-500 mt-1">All students across the school.</p>
        </div>
        <div className="flex items-center gap-2">
          <motion.button onClick={openAddStudent} whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}
      ...
      {loading ? (
        ...
        <div className="card-premium bg-white border border-brand-border rounded-3xl overflow-hidden">
            ...
            >
              <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg flex flex-col max-h-[88vh]">
                <div className="flex items-center justify-between px-6 pt-6 pb-4 border-b border-brand-border/60 shrink-0">
                  ...
                  <button onClick={() => setShowAddStudent(false)} className="p-2 rounded-xl hover:bg-stone-100 text-stone-500 hover:text-stone-700 transition-colors">
                    <X className="w-4 h-4" />
                  </button>
                </div>
                  ...
                  <form id="admin-student-form" onSubmit={handleCreateStudent} className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div>
                        ...
                        <select value={studentForm.grade} onChange={(e) => setField('grade', Number(e.target.value))}
                          className="w-full px-3 py-2.5 bg-stone-50 border border-brand-border rounded-xl text-sm font-medium text-brand-dark focus:outline-none focus:border-brand-dark focus:ring-2 focus:ring-brand-dark/10 transition-all">
