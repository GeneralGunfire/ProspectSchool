...
export default function MarketplacePage({ sellerType, sellerId, schoolId, studentGrade }: MarketplacePageProps) {
  ...
  return (
    <div className="student-home min-h-full pb-16 relative">
      ...
      {/* Tabs + primary action */}
      <div className="paper-card rounded p-1.5 flex flex-wrap items-center justify-between gap-3 mb-6">
            ...
            return (
              <button
                ...
                className={`px-4 py-2 rounded text-[13px] font-bold transition-all duration-150 ${
                  active ? 'bg-brand-dark text-white' : 'text-stone-500 hover:bg-(--color-paper-raise) hover:text-brand-dark'
                }`}
        ...
        {(tab === 'browse' || tab === 'mine') && (
          <motion.button
            ...
            className="shrink-0 flex items-center gap-2 text-white text-[13px] font-bold px-4 py-2.5 rounded transition-colors mr-1"
