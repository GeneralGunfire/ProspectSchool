...
export default function PastPapersPage({ session }: PastPapersPageProps) {
  ...
  return (
    <div className="student-home min-h-full pb-16 relative">
      ...
      {/* ── Upload Modal ──────────────────────────────────────── */}
      <Modal open={modal} onClose={closeModal} title="Upload past paper" maxWidth="max-w-lg"
        footer={<>
          <button onClick={closeModal} className="text-[14px] font-semibold text-muted transition-colors">
            Cancel
          </button>
