...
export default function TeacherDashboard({ onNavigate }: TeacherDashboardProps) {
  ...
  const mobileNavItems = navItems.slice(0, 5); // Home, Announcements, Classes, Calendar, Marks
  ...
  return (
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      <div className="flex-1 min-w-0 flex flex-col overflow-hidden">
        ...
        {/* ── Mobile bottom nav ─────────────────────────────── */}
        <nav
          className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-slate-100 flex items-center z-40"
