      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="block text-[11px] font-black uppercase tracking-[0.18em] text-brand-eyebrow mb-2">Admin Code</label>
              <div className="relative">
                <input
                  type="text" required
            ...
            <div>
              ...
              <p className="text-[11px] text-brand-eyebrow mt-1.5">Assigned by your platform administrator</p>
            </div>
            ...
            <label className="flex items-center gap-2.5 cursor-pointer select-none">
              ...
              />
              <span className="text-[12px] font-medium text-brand-eyebrow">Remember school &amp; admin code</span>
            </label>
