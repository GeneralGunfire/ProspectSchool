...
export default function StudentLogin({ onNavigate }: { onNavigate: (page: string) => void }) {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-5 py-12 overflow-hidden">
      {/* Full-bleed photo */}
      <picture>
        <source srcSet="/images/students.webp" type="image/webp" />
        <img
      ...
      {/* Warm dark scrim — ties the photo to the brand palette and keeps the
          glass card legible */}
      <div
        aria-hidden
      ...
      >
        <p className="text-[10px] font-black uppercase tracking-[0.22em] text-amber-200/80 mb-3">For Learners</p>
        <h1 className="font-black text-white text-2xl leading-tight" style={{ letterSpacing: '-0.03em' }}>
          Sign in to your account
        </h1>
        <p className="text-white/50 text-[13px] mt-2">Enter the codes provided by your school.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-7">
          ...
          <div>
            ...
            <p className="text-[11px] text-white/35 mt-1.5">Assigned by your teacher</p>
          </div>
          ...
          <label className="flex items-center gap-2.5 cursor-pointer select-none">
            ...
            />
            <span className="text-[11px] font-bold text-white/50">Remember school &amp; student code</span>
          </label>
