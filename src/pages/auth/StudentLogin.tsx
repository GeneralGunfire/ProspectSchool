      ...
      <div className="relative z-10 flex-1 flex items-center justify-center px-4 py-12">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="block text-[11px] font-black uppercase tracking-[0.18em] text-white/45 mb-2">Student Code</label>
              <div className="relative">
                <input
                  type="text" required
            ...
            <div>
              ...
              <p className="text-[11px] text-white/30 mt-1.5">Assigned by your teacher</p>
            </div>
            ...
            <label className="flex items-center gap-2.5 cursor-pointer select-none">
              ...
              />
              <span className="text-[12px] font-medium text-white/45">Remember school &amp; student code</span>
            </label>
