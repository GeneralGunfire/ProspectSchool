  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center px-4 py-12">
        ...
        >
          <p className="text-[10px] font-black uppercase tracking-[0.2em] text-accent mb-3">For Parents</p>
          ...
          <p className="text-stone-500 text-[14px] font-medium mb-8">
            Enter the codes provided by your child's school.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="block text-[11px] font-black uppercase tracking-[0.18em] text-stone-500 mb-2">Parent Code</label>
              <div className="relative">
                <input
                  type="text" required
            ...
            <div>
              ...
              <p className="text-[11px] text-stone-400 mt-1.5">Assigned by your school</p>
            </div>
            ...
            <label className="flex items-center gap-2.5 cursor-pointer select-none">
              ...
              />
              <span className="text-[12px] font-medium text-stone-500">Remember school &amp; parent code</span>
            </label>
