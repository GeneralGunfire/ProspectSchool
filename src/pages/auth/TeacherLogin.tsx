      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="block text-[11px] font-black uppercase tracking-[0.18em] text-brand-eyebrow mb-2">Teacher Code</label>
              <div className="relative">
                <input
                  type="text" required
            ...
            <div>
              ...
              <p className="text-[11px] text-brand-eyebrow mt-1.5">Assigned by your school administrator</p>
            </div>
