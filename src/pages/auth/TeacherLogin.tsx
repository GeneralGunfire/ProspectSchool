      ...
      <div className="relative z-10 flex-1 flex items-center justify-center px-4 py-12">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="block text-[11px] font-black uppercase tracking-[0.18em] text-stone-500 mb-2">Teacher Code</label>
              <div className="relative">
                <input
                  type="text" required
            ...
            <label className="flex items-center gap-2.5 cursor-pointer select-none">
              ...
              />
              <span className="text-[12px] font-medium text-stone-500">Remember school &amp; teacher code</span>
            </label>
