...
export default function TeacherLogin({ onNavigate }: { onNavigate: (page: string) => void }) {
  ...
  return (
    <div className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      {/* Background image */}
      <img
        src="https://images.unsplash.com/photo-1524178232363-1fb2b075b655?w=1600&q=80&fit=crop"
        alt="" aria-hidden
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center px-4 py-12">
        ...
        >
          <p className="text-[10px] font-black uppercase tracking-[0.2em] text-accent mb-3">For Teachers</p>
          ...
          <p className="text-white/50 text-[14px] font-medium mb-8">
            Enter the codes provided by your school administrator.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-11 bg-white/8 border border-white/15 rounded-xl text-sm font-bold text-white placeholder:text-white/20 focus:outline-none focus:border-accent/60 focus:ring-2 focus:ring-accent/15 transition-all tracking-widest"
            ...
            <div>
              <label className="block text-[11px] font-black uppercase tracking-[0.18em] text-white/45 mb-2">Teacher Code</label>
              <div className="relative">
                <input
                  type="text" required
            ...
            <div>
              ...
              <p className="text-[11px] text-white/30 mt-1.5">Assigned by your school administrator</p>
            </div>
            ...
            <label className="flex items-center gap-2.5 cursor-pointer select-none">
              ...
              />
              <span className="text-[12px] font-medium text-white/45">Remember school &amp; teacher code</span>
            </label>
